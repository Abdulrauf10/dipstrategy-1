...
import bgD from './sources/bg-d.png'
  ...
  return (
    <div className="app">
      <section className="section-1">
        <div className="bg-d">
          <img src={bgD} alt="background" className='bg'/>
        </div>
        <Navbar/>
        <div className="row" style={{width: '100%'}}>
          <div className="col-9">
            <h1 className='service'>we assist you in <br/> solving tomorrow's <br/> <span className='white-title'>problems today</span></h1>
          </div>
          <div className="col-3">
